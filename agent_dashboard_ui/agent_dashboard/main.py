...
class AgentDashboard(QMainWindow, ButtonSelectionMixin):
    ...
    def initUI(self):
        ...
        self.dashboard_btn.setFont(QFont('Arial', self.btn_font_size))
        ...
        self.email_template_btn.setFont(QFont('Arial', self.btn_font_size))
        ...
        self.format_btn.setFont(QFont('Arial', self.btn_font_size))
        ...
        self.contact_btn.setFont(QFont('Arial', self.btn_font_size))
